...
0x0A,0x0C,0x17,0x01,0x2B,0x01,0x00,0x00,// 0..7
0x00,0x00,0x00,0x00,0xA0,0x20,0x10,0x80,// 8..15
0x00,0x00,0x80,0xFF,0x00,0x00,0x80,0x7F,// 16..23
0x08,0x00,0x6D,0x6D,0x00,0x78,0x5F,0x70,// 24..31
0x6F,0x73,0x00,0x00,0x00,0x00,0x00,0x00,// 32..39
0xA0,0x20,0x10,0x80,0x00,0x00,0x80,0xFF,// 40..47
0x00,0x00,0x80,0x7F,0x23,0x00,0x6D,0x6D,// 48..55
0x00,0x79,0x5F,0x70,0x6F,0x73,0x00,0x00,// 56..63
0x00,0x00,0x00,0x00,0xA0,0x20,0x10,0x80,// 64..71
0x00,0x00,0x80,0xFF,0x00,0x00,0x80,0x7F,// 72..79
0x3F,0x00,0x6D,0x6D,0x00,0x7A,0x5F,0x70,// 80..87
0x6F,0x73,0x00,0x00,0x00,0x00,0x00,0x00,// 88..95
0xA0,0x20,0x10,0x00,0x00,0x00,0x80,0xFF,// 96..103
0x00,0x00,0x80,0x7F,0x5B,0x00,0x72,0x61,// 104..111
0x64,0x00,0x70,0x6F,0x73,0x5F,0x66,0x62,// 112..119
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,// 120..127
0xA0,0x20,0x10,0x00,0x00,0x00,0x80,0xFF,// 128..135
0x00,0x00,0x80,0x7F,0x79,0x00,0x72,0x61,// 136..143
0x64,0x00,0x76,0x65,0x6C,0x5F,0x66,0x62,// 144..151
0x00,0x00,0x00,0x00,0xA0,0x04,0x01,0x00,// 152..159
0x00,0x00,0xC8,0xC2,0x00,0x00,0xC8,0x42,// 160..167
0x99,0x00,0x6E,0x6F,0x6E,0x65,0x00,0x69,// 168..175
0x6E,0x00,0x00,0x00,0xA0,0x01,0x07,0x00,// 176..183
0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x3F,// 184..191
0xB2,0x00,0x6E,0x6F,0x6E,0x65,0x00,0x66,// 192..199
0x61,0x75,0x6C,0x74,0x00,0x00,0x00,0x00,// 200..207
0x00,0x00,0x00,0x00,0xA0,0x20,0x10,0x80,// 208..215
0x00,0x00,0x80,0xFF,0x00,0x00,0x80,0x7F,// 216..223
0xCD,0x00,0x6E,0x6F,0x6E,0x65,0x00,0x73,// 224..231
0x63,0x61,0x6C,0x65,0x00,0xB0,0x00,0x01,// 232..239
0x00,0x50,0x6F,0x73,0x69,0x74,0x69,0x6F,// 240..247
0x6E,0x20,0x6D,0x6F,0x64,0x65,0x00,0x00,// 248..255
0xA0,0x03,0x00,0x00,0x00,0x00,0x00,0x00,// 256..263
0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x70,// 264..271
0x61,0x64,0x64,0x69,0x6E,0x67,0x00,0x0C,// 272..279
0x00,0x28,0x00,0x44,0x00,0x60,0x00,0x80,// 280..287
0x00,0x9C,0x00,0xB4,0x00,0x00,0x01,0x00,// 288..295
0x00,0x00,0x00,0xD4,0x00,0xED,0x00,0x00,// 296..303
0x00,
};
...
//global name:scale addr:0xcd size:32 dir:0x80
#define scale_address 205
...
void frt_func(sserial_pin_ctx_t *pins) {
  ...
  if(available >= 1) {
    ...
    if(lbp.ct == CT_LOCAL && lbp.wr == 0) {  //local read, cmd+crc = 2b
      ...
      {  //process data, requires cmd+output bytes+crc
...
*/
        ...
        if(crc_reuest(discovery.output + 1)) {
          ...
          pins->x_pos   = data_out.x_pos;
          pins->y_pos   = data_out.y_pos;
          pins->z_pos   = data_out.z_pos;
